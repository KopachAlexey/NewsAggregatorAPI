        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleName = table.Column<int>(type: "int", maxLength: 50, nullable: false, defaultValue: 3)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Sources_Name_Url", x => new { x.Name, x.Url });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Users_Login_Email", x => new { x.Login, x.Email });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Url = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    PositivityRate = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ValidRate", "PositivityRate >= -10 AND PositivityRate <= 10");
                    table.ForeignKey(
